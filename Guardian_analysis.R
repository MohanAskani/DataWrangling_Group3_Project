...
guardian_news <- guardian_news %>% mutate(publisher = "The Gaurdian") %>% select(date, publisher, title, url, body, cleaned_body)
...
guardian_data_tokenized_unigrams <- tokenisation_standardisation_unigrams(guardian_news)
...
guardian_data_tokenized_bigrams <- tokenisation_standardisation_bigrams(guardian_news)
